	...
	union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_CAPACITY:
		// prize modify by liaoxingen bug start
#if 0
...
#endif
		// prize modify by liaoxingen bug end
...
//prize add by lipengpeng 20191221 start
	...
	|| defined(CONFIG_MT6360_PMU_CHARGER) || defined(CONFIG_HL7005ALL_CHARGER_SUPPORT)\
	|| defined(CONFIG_OZ115_SUPPORT) || defined(CONFIG_CHARGER_RT9467) || defined(CONFIG_CHARGER_RT9471)\
	|| defined(CONFIG_CHARGER_SGM41512) || defined(CONFIG_CHARGER_V1_SGM41512)
//prize add by lipengpeng 20191221 end
	...
	if (upmu_get_rgs_chrdet()){
		...
		bm_debug("[EM] FG_Battery_CurrentConsumption : %d mA\n", ret_value);
...
//start add by sunshuai 2019-04-03 for charge  current  show
		...
		bm_debug("[EM] ibat_6370 : %d mA, ret_value=%d \n", ibat_6370,ret_value);
#endif
//start add by sunshuai 2019-04-03 for charge  current  show		
