...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_sc1300cs[] = {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_sc1300cs[] = {
	0x0100,0x00,
	0x3220,0x01,
	0x3200,0x00,
	0x3201,0x00,
...
#if MULTI_WRITE
	sc1300cs_table_write_cmos_sensor(
		addr_data_pair_preview_sc1300cs,
		sizeof(addr_data_pair_preview_sc1300cs) / sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0100,0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_sc1300cs[] = {
	0x0100,0x00,
	0x3220,0x00,
	0x3200,0x00,
	0x3201,0x00,
	...
	0x5000,0x0e,
	0x5901,0x00,
	0x320e,0x19, //.framelength =3200,//30fpsset FOR 1300CS
	0x320f,0x00, //.framelength =3200,//30fpsset FOR 1300CS

};

kal_uint16 addr_data_pair_capture_30fps_sc1300cs[] = {
	0x0100,0x00,
	0x3220,0x00,
	0x3200,0x00,
	0x3201,0x00,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 150) {
		sc1300cs_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_sc1300cs,
			sizeof(addr_data_pair_capture_15fps_sc1300cs) /
			sizeof(kal_uint16));
	} else {
		sc1300cs_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_sc1300cs,
			sizeof(addr_data_pair_capture_30fps_sc1300cs) /
			sizeof(kal_uint16));
	}
#else
	write_cmos_sensor(0x0100,0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_video_sc1300cs[] = {
	0x0100,0x00,
	0x3220,0x00,
	0x3200,0x00,
	0x3201,0x00,
...
#if MULTI_WRITE
	sc1300cs_table_write_cmos_sensor(
		addr_data_pair_video_sc1300cs,
		sizeof(addr_data_pair_video_sc1300cs) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0100,0x00);
	write_cmos_sensor(0x3220,0x00);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_sc1300cs[] = {
	0x0100,0x00,
	0x3220,0x01,
	0x3200,0x03,
	0x3201,0x38,
...
{
	cam_pr_debug("E RES_1280x720_120fps\n");
#if MULTI_WRITE
	sc1300cs_table_write_cmos_sensor(
		addr_data_pair_hs_video_sc1300cs,
		sizeof(addr_data_pair_hs_video_sc1300cs) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0100,0x00);
	write_cmos_sensor(0x3220,0x01);
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_slim_video_sc1300cs[] = {
	0x0100,0x00,
	0x3220,0x01,
	0x3200,0x00,
	0x3201,0xb8,
...
#if MULTI_WRITE
	sc1300cs_table_write_cmos_sensor(
		addr_data_pair_slim_video_sc1300cs,
		sizeof(addr_data_pair_slim_video_sc1300cs) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0100,0x00);
	write_cmos_sensor(0x3220,0x01);
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	if (enable) {
		...
		write_cmos_sensor(0x3e07, 0xC5);
		write_cmos_sensor(0x3e07, 0x40);
	} else {
...
UINT32 SC1300CS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
