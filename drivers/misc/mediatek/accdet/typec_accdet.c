...
//prize add by lipengpeng 20191129 Wireless charging is not possible when the headset is plugged in(jira AS-2284) start 
...
int typec_accdet_mic_detect(void){
	...
	//accdet_val = pmic_get_auxadc_value(AUXADC_LIST_ACCDET);
		accdet_val = accdet_auxadc_get_val();
	//prize add by lipengpeng 20220505 end
