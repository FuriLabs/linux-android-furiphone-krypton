...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0x02, 0x10);
	lcm_dcs_write_seq_static(ctx, 0x03, 0x10);
	
	lcm_dcs_write_seq_static(ctx, 0x08, 0x80);
	lcm_dcs_write_seq_static(ctx, 0x09, 0x12);
	lcm_dcs_write_seq_static(ctx, 0x0a, 0x71);
	lcm_dcs_write_seq_static(ctx, 0x0b, 0x00);
	lcm_dcs_write_seq_static(ctx, 0x14, 0x8A);
	lcm_dcs_write_seq_static(ctx, 0x15, 0x8A);
	lcm_dcs_write_seq_static(ctx, 0x0c, 0x10);
	lcm_dcs_write_seq_static(ctx, 0x0d, 0x10);
	...
	lcm_dcs_write_seq_static(ctx, 0x31, 0x21);
	...
	lcm_dcs_write_seq_static(ctx, 0x3e, 0x13);
	lcm_dcs_write_seq_static(ctx, 0x3f, 0x11);
	lcm_dcs_write_seq_static(ctx, 0x40, 0x09);
	...
	lcm_dcs_write_seq_static(ctx, 0x04, 0xe0);
	lcm_dcs_write_seq_static(ctx, 0x58, 0x62);
	
	lcm_dcs_write_seq_static(ctx, 0x63, 0x88);
	lcm_dcs_write_seq_static(ctx, 0x64, 0x8A);
	lcm_dcs_write_seq_static(ctx, 0x68, 0xAA);
	lcm_dcs_write_seq_static(ctx, 0x69, 0xB1);
	lcm_dcs_write_seq_static(ctx, 0x6A, 0x86);
	lcm_dcs_write_seq_static(ctx, 0x6B, 0x78);
	...
	lcm_dcs_write_seq_static(ctx, 0x13, 0x54);
	...
	//lcm_dcs_write_seq_static(ctx, 0x7C, 0x40);//3-Lane				 //0525
	//lcm_dcs_write_seq_static(ctx, 0xDD, 0x10);//3-Lane				 //0525
...
//prize add by lipengpeng 20210723 start 
extern int ilitek_tddi_sleep_handler(int mode);
extern int ilitek_probe_sucess;
//prize add by lipengpeng 20210723 end 
...
//prize add by lipengpeng 20210723 start 
		printk("lpp---ili9881h  enter lcm suspend  ilitek_probe_sucess=%d\n",ilitek_probe_sucess);
		if(1==ilitek_probe_sucess)
		ilitek_tddi_sleep_handler(1);
//prize add by lipengpeng 20210723 end 
