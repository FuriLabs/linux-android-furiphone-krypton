...
//prize add by lipengpeng 20210401 start
 #define ZXYGMS_MODULE_ID_OFFSET  0x0001
static kal_uint16 read_module_id_gms(void)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(ZXYGMS_MODULE_ID_OFFSET >> 8), (char)(ZXYGMS_MODULE_ID_OFFSET & 0xFF)};
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	kal_uint16 module_id = 0,zxygms_id = 0;
