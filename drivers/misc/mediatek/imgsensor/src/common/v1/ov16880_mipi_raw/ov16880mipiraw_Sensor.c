...
static imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.grabwindow_width = 2304,//2336-32,Glenn		//record different mode's width of grabwindow
		.grabwindow_height = 1728,//1752-24,		//record different mode's height of grabwindow
		/*	 following for MIPIDataLowPwr2HighSpeedSettleDelayCount by different scenario	*/
		.mipi_data_lp2hs_settle_dc = 85,//unit , ns
		.mipi_pixel_rate = 435200000,
		.pixel_rate = 435200000,
	...
	.cap = { /* 95:line 5312, 52/35:line 5336 */
		...
		.startx = 0,
		.starty = 0,
		.grabwindow_width = 4608,//4672-64,Glenn
		.grabwindow_height = 3456,//3504-48,//
		.mipi_data_lp2hs_settle_dc = 105,//unit , ns
		.mipi_pixel_rate = 676800000,/*OP Pixel rate*/
		.pixel_rate = 676800000,
		.max_framerate = 300,
		},
	.cap1 = {
		.pclk = 288000000,
  ...
  .cap2 = {
	...
	.sensor_output_dataformat = SENSOR_OUTPUT_FORMAT_RAW_B,//SENSOR_OUTPUT_FORMAT_RAW_B,SENSOR_OUTPUT_FORMAT_RAW_Gr,SENSOR_OUTPUT_FORMAT_RAW_Gb,SENSOR_OUTPUT_FORMAT_RAW_R
	.mclk = 24,
...
//prize add by lipengpeng 20201106 start 
...
//prize add by lipengpeng 20201106 end
...
//	{{ 4704, 3536,	   32,	 32, 4640, 3472, 2320, 1736,  8, 4,  2304, 1728,	 0,    0, 2304, 1728}, // Preview 
// { 4704, 3536,	   32,	 32, 4640, 3472, 4640, 3472, 16, 8, 4608, 3456,	 0,    0, 4608, 3456}, // capture 
#else
	write_cmos_sensor_8(0x3800, 0x00);
...
*
*************************************************************************/
//prize add by lipengpeng 20210714 start 
int Check_to_Dmode=0;
//prize add by lipengpeng 20210714 end 
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.autoflicker_en = KAL_FALSE;
	spin_unlock(&imgsensor_drv_lock);
//prize add by liuxuhui 20221107 start 
	sensor_init();
	mdelay(20);
//prize add by liuxuhui 20221107 end
	preview_setting();
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	imgsensor.autoflicker_en = KAL_FALSE;
	spin_unlock(&imgsensor_drv_lock);
//prize add by lipengpeng 20210716 start 
    sensor_init();
	//mdelay(20);
//prize add by lipengpeng 20210716 end 
	hs_video_setting();
	//set_mirror_flip(IMAGE_NORMAL);
	return ERROR_NONE;
}	/*	hs_video   */
