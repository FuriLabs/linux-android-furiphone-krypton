 ...
 *
 ****************************************************************************/
#ifndef _S5K3p9gmsMIPI_SENSOR_H
#define _S5K3p9gmsMIPI_SENSOR_H
...
extern bool S5K3p9gms_read_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size);
