...
void prize_ili_sleep_handler(void)
{
...
#endif
//prize Solve the TP boot probability no touch problem lipengpeng 20220722 start
    ili_tp_reset(); 
//prize Solve the TP boot probability no touch problem lipengpeng 20220722 start
	ili_ic_get_core_ver();
...
#if 0//LINUX_VERSION_CODE < KERNEL_VERSION(5, 4, 0)//prize-modify-pengzhipeng-20220701
