 ...
 * Filename:
 * ---------
 *   OV64B40GMS_REAR_rear_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "ov64b40gmsmipiraw_Sensor.h"
#include "ov64b40gms_Sensor_setting.h"
#define PFX "OV64B40GMS_camera_sensor"
...
#if OV64B40GMS_MIRROR_FLIP_ENABLE
...
static kal_uint16 ov64b40gms_table_write_cmos_sensor(
...
static void sensor_init(void)
{
	...
	mdelay(10);
	LOG_INF("sensor_init\n");
	ov64b40gms_table_write_cmos_sensor(
		addr_data_pair_init_ov64b40gms,
		sizeof(addr_data_pair_init_ov64b40gms) / sizeof(kal_uint16));
}
...
static void preview_setting(void)
{
	...
	ov64b40gms_table_write_cmos_sensor(
		addr_data_pair_preview_ov64b40gms,
		sizeof(addr_data_pair_preview_ov64b40gms) / sizeof(kal_uint16));
}
...
static void capture_setting(kal_uint16 currefps)
{
	...
	ov64b40gms_table_write_cmos_sensor(
		addr_data_pair_capture_ov64b40gms,
		sizeof(addr_data_pair_capture_ov64b40gms) /
		sizeof(kal_uint16));
}
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	ov64b40gms_table_write_cmos_sensor(
		addr_data_pair_video_ov64b40gms,
		sizeof(addr_data_pair_video_ov64b40gms) /
		sizeof(kal_uint16));
}
...
static void hs_video_setting(void)
{
	...
	ov64b40gms_table_write_cmos_sensor(
		addr_data_pair_hs_video_ov64b40gms,
		sizeof(addr_data_pair_hs_video_ov64b40gms) /
		sizeof(kal_uint16));
}
...
static void slim_video_setting(void)
{
	...
	ov64b40gms_table_write_cmos_sensor(
		addr_data_pair_slim_video_ov64b40gms,
		sizeof(addr_data_pair_slim_video_ov64b40gms) /
		sizeof(kal_uint16));
}
...
{
  LOG_INF("E\n");
  ov64b40gms_table_write_cmos_sensor(addr_data_pair_custom1_ov64b40gms,
		sizeof(addr_data_pair_custom1_ov64b40gms) / sizeof(kal_uint16));
}	/*	custom1_setting  */

static void custom2_setting(void)
{
  LOG_INF("E\n");
  ov64b40gms_table_write_cmos_sensor(addr_data_pair_custom2_ov64b40gms,
		sizeof(addr_data_pair_custom2_ov64b40gms) / sizeof(kal_uint16));
}	/*	custom2_setting  */
...
static void custom3_setting(void)
{
  LOG_INF("E\n");
#if REMOSAIC_SUPPORT
  ov64b40gms_table_write_cmos_sensor(addr_data_pair_custom3_ov64b40gms,
		sizeof(addr_data_pair_custom3_ov64b40gms) / sizeof(kal_uint16));
#else
  ov64b40gms_table_write_cmos_sensor(addr_data_pair_capture_ov64b40gms,
		sizeof(addr_data_pair_capture_ov64b40gms) / sizeof(kal_uint16));
#endif
}	/*	custom3_setting  */
static void custom4_setting(void)
{
  LOG_INF("E\n");
  ov64b40gms_table_write_cmos_sensor(addr_data_pair_custom4_ov64b40gms,
		sizeof(addr_data_pair_custom4_ov64b40gms) / sizeof(kal_uint16));
}	/*	custom4_setting  */
static void custom5_setting(void)
{
  LOG_INF("E\n");
  ov64b40gms_table_write_cmos_sensor(addr_data_pair_custom5_ov64b40gms,
		sizeof(addr_data_pair_custom5_ov64b40gms) / sizeof(kal_uint16));
}	/*	custom5_setting  */
...
static int read_gms_module_flag(void)
{
	kal_uint16 ret;
...
UINT32 OV64B40GMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
