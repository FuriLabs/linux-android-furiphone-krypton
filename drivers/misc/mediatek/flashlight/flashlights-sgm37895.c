 ...
 *****************************************************************************/
 //prize add by lipengpeng 20210906 start 
 extern int aw36515b_is_check;
 //prize add by lipengpeng 20210906 end 
...
//prize add by lipengpeng 20210906 start 0xC0
    if(aw36515b_is_check ==0)
	{
		printk("chip id ok is 37895 =%d\n",aw36515b_is_check);
	}else{
		printk("chip id fail is 37895 =%d\n",aw36515b_is_check);
		return 0;
	}
...
static void __exit flashlight_sgm37895_exit(void)
{
 ...
 //prize add by lipengpeng 20210906 start 
late_initcall(flashlight_sgm37895_init);
 //prize add by lipengpeng 20210906 start 
