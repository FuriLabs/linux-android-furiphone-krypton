...
#define PFX "IMX486GMS_camera_sensor"
...
#include "imx486gmsmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	/* IMX486GMSMIPI_SENSOR_ID, sensor_id = 0x2680*/
	.sensor_id = IMX486GMS_SENSOR_ID,
...
static kal_uint16 imx486gms_table_write_cmos_sensor(
...
#define IMX486GMSMIPI_MaxGainIndex (193)
kal_uint16 IMX486GMSMIPI_sensorGainMapping[IMX486GMSMIPI_MaxGainIndex][2] = {
	{64, 0},
	{66, 16},
	{68, 30},
	{70, 44},
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	return reg_gain;
#else
	for (i = 0; i < IMX486GMSMIPI_MaxGainIndex; i++) {
		if (gain <= IMX486GMSMIPI_sensorGainMapping[i][0])
			break;
	}
	if (gain != IMX486GMSMIPI_sensorGainMapping[i][0])
		LOG_INF("Gain mapping don't correctly:%d %d\n", gain,
			IMX486GMSMIPI_sensorGainMapping[i][0]);
	return IMX486GMSMIPI_sensorGainMapping[i][1];
#endif
}
...
#if 0
	/*      preview_setting  */
static void imx486gms_ImageQuality_Setting(void)
{
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_init_imx486gms[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x4979, 0x0d,
	0x3040, 0x03,
...
//From reg tool at 2018-1-6 16:54
	...
	imx486gms_table_write_cmos_sensor(
		addr_data_pair_init_imx486gms,
		sizeof(addr_data_pair_init_imx486gms) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_preview_imx486gms[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x08,
...
static void preview_setting(void)
{
	...
	imx486gms_table_write_cmos_sensor(
		...
		sizeof(addr_data_pair_preview_imx486gms) /
		sizeof(kal_uint16));
#else
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_capture_15fps_imx486gms[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x10,
...
kal_uint16 addr_data_pair_capture_24fps_imx486gms[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x10,
...
kal_uint16 addr_data_pair_capture_30fps_imx486gms[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x10,
...
static void capture_setting(kal_uint16 curretfps, kal_uint8 pdaf_mode)
{
	...
	if (curretfps == 150) {
		imx486gms_table_write_cmos_sensor(
			addr_data_pair_capture_15fps_imx486gms,
			sizeof(addr_data_pair_capture_15fps_imx486gms) /
			sizeof(kal_uint16));
	} else if (curretfps == 240) {
		imx486gms_table_write_cmos_sensor(
			addr_data_pair_capture_24fps_imx486gms,
			sizeof(addr_data_pair_capture_24fps_imx486gms) /
			sizeof(kal_uint16));
	} else {
		imx486gms_table_write_cmos_sensor(
			addr_data_pair_capture_30fps_imx486gms,
			sizeof(addr_data_pair_capture_30fps_imx486gms) /
			sizeof(kal_uint16));
	}
#else
	if (curretfps == 150) {
...
#if MULTI_WRITE
kal_uint16 addr_data_pair_hs_video_imx486gms[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x08,
...
#if MULTI_WRITE
	imx486gms_table_write_cmos_sensor(
		addr_data_pair_hs_video_imx486gms,
		sizeof(addr_data_pair_hs_video_imx486gms) /
		sizeof(kal_uint16));
#else
	write_cmos_sensor(0x0112, 0x0A);
	write_cmos_sensor(0x0113, 0x0A);
 ...
 *
 *************************************************************************/
  #define IMX486GMS_MODULE_ID_OFFSET  0x0001
static kal_uint16 read_imx486gmsmodule_id(void)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(IMX486GMS_MODULE_ID_OFFSET >> 8), (char)(IMX486GMS_MODULE_ID_OFFSET & 0xFF)};

	iReadRegI2C(pusendcmd, 2, (u8 *)&get_byte, 1, 0xA0/*EEPROM_READ_ID*/);   //A0 && B0 ????
	pr_err("imx486gms_read_ylmodule_id id is %d\n", get_byte);
	return get_byte;
}
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		#if 0
		read_imx486gms_pdaf((kal_uint16) (*feature_data),
...
UINT32 IMX486GMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
}				/*      IMX486GMS_MIPI_RAW_SensorInit      */
