 ...
 *=====================================================
 ************************************************************************/
#define PFX "IMX481SUB2_camera_sensor"
...
#include "imx481sub2mipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.sensor_id = IMX481SUB2_SENSOR_ID,
...
static kal_uint32 return_mod_id_from_otp(void)
{
	...
	pr_debug("IMX481SUB2 read otp MID 0x%x\n",mid_val);
...
static kal_uint32 return_lot_id_from_otp(void)
{
	...
	sensor_id =  ((read_cmos_sensor(0x0A22) << 4) | read_cmos_sensor(0x0A23) >> 4) + 2;
	if(mid_val == 0x1A)
	{
		sensor_id +=1;
	}
...
#endif
static kal_uint16 imx481sub2_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_imx481sub2[] = {
...
{
	pr_debug("02E\n");
	imx481sub2_table_write_cmos_sensor(addr_data_pair_init_imx481sub2,
	    sizeof(addr_data_pair_init_imx481sub2)/sizeof(kal_uint16));
...
kal_uint16 addr_data_pair_preview_imx481sub2[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx481sub2_table_write_cmos_sensor(
	addr_data_pair_preview_imx481sub2,
	sizeof(addr_data_pair_preview_imx481sub2) / sizeof(kal_uint16));
} /* preview_setting */


kal_uint16 addr_data_pair_capture_imx481sub2[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx481sub2_table_write_cmos_sensor(addr_data_pair_capture_imx481sub2,
		sizeof(addr_data_pair_capture_imx481sub2) / sizeof(kal_uint16));
	//	mDELAY(25);
...
kal_uint16 addr_data_pair_video_imx481sub2[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	pr_debug("E! %s:%d\n", __func__, currefps);
	imx481sub2_table_write_cmos_sensor(addr_data_pair_video_imx481sub2,
		sizeof(addr_data_pair_video_imx481sub2) / sizeof(kal_uint16));
//		mDELAY(25);
//		write_cmos_sensor(0x0100,0x00);
//		mDELAY(50);
//		write_cmos_sensor(0x0100,0x01);
...
kal_uint16 addr_data_pair_hs_video_imx481sub2[] = {	/*720 120fps */
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx481sub2_table_write_cmos_sensor(addr_data_pair_hs_video_imx481sub2,
		sizeof(addr_data_pair_hs_video_imx481sub2) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_imx481sub2[] = {
	/* MIPI output setting */
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx481sub2_table_write_cmos_sensor(addr_data_pair_slim_video_imx481sub2,
	    sizeof(addr_data_pair_slim_video_imx481sub2) / sizeof(kal_uint16));
}
...
static kal_uint32 open(void)
{
	...
	pr_debug("IMX481SUB2, MIPI 4LANE\n");
	pr_debug(
...
static void check_stream_is_on(void)
{
	...
	for (i = 0; i < timeout; i++) {
		...
		if (framecnt != 0xFF) {
			pr_debug("IMX481SUB2 stream is on, %d \\n", framecnt);
			break;
		}
		pr_debug("IMX481SUB2 stream is not on %d \\n", framecnt);
		mdelay(1);
	}
}
...
UINT32 IMX481SUB2_MIPI_RAW_SensorInit(
			struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* IMX481SUB2_MIPI_RAW_SensorInit */
