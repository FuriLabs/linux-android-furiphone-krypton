...
#include "imx350main2mipiraw_Sensor.h"
#define PFX "IMX350MAIN2_camera_sensor"
#define LOG_1 LOG_INF("IMX350MAIN2,MIPI 4LANE\n")
#define LOG_2 LOG_INF("preview 2592*1936@30fps; video 5344*4016@30fps; capture 21M@24fps\n")
#undef IMX350MAIN2_24_FPS
...
static BYTE imx350main2_SPC_data[352] = { 0 };
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = IMX350MAIN2_SENSOR_ID,	/* record sensor id defined in Kd_imgsensor.h */
...
#define IMX350MAIN2MIPI_MaxGainIndex (177)
kal_uint16 imx350main2MIPI_sensorGainMapping[IMX350MAIN2MIPI_MaxGainIndex][2] = {
{64,0},
  {68,60},
  {72,114},
  {76,162},
...
static void imx350main2_set_pd_focus_area(MUINT32 startpos, MUINT32 size)
{
...
static void imx350main2_get_pdaf_reg_setting(
...
static void imx350main2_set_pdaf_reg_setting(
	MUINT32 regNum, kal_uint16 *regDa)
{
	int i, idx;
	for (i = 0; i < regNum; i++) {
...
static void imx350main2_apply_SPC(void)
{
	...
	memcpy((void *)&puSendCmd[tosend], imx350main2_SPC_data, 352);
	tosend += 352;
...
static kal_uint32 return_lot_id_from_otp(void)
{
	...
	return ((read_cmos_sensor(0x0A22) << 4) | read_cmos_sensor(0x0A23) >> 4) + 1;
}
...
{
	kal_uint8 iI;
	for (iI = 0; iI < IMX350MAIN2MIPI_MaxGainIndex; iI++) {
		if (gain <= imx350main2MIPI_sensorGainMapping[iI][0])
			return imx350main2MIPI_sensorGainMapping[iI][1];
	}
	return imx350main2MIPI_sensorGainMapping[iI - 1][1];
}
...
#endif
static kal_uint16 imx350main2_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_imx350main2_zvhdr_on[] = {
	0x30b1, 0x00,
	0x30c6, 0x00,
	0x30b2, 0x00,
	0x30b3, 0x00,
...
kal_uint16 addr_data_pair_imx350main2_zvhdr_off[] = {
	0x30b4, 0x00,
	0x30b5, 0x00,
	0x30b6, 0x00,
	0x30b7, 0x00,
...
static kal_uint16 zvhdr_setting(void)
{
	...
	if (imgsensor.hdr_mode == 9) {
		imx350main2_table_write_cmos_sensor(addr_data_pair_imx350main2_zvhdr_on,
		sizeof(addr_data_pair_imx350main2_zvhdr_on) / sizeof(kal_uint16));
	} else {
		imx350main2_table_write_cmos_sensor(addr_data_pair_imx350main2_zvhdr_off,
		sizeof(addr_data_pair_imx350main2_zvhdr_off) / sizeof(kal_uint16));
	}
	return 0;
}
kal_uint16 addr_data_pair_init_imx350main2[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x3C7D, 0x28,
	0x3C7E, 0x01,
...
{
	LOG_INF("E\n");
	imx350main2_table_write_cmos_sensor(addr_data_pair_init_imx350main2,
		sizeof(addr_data_pair_init_imx350main2)/sizeof(kal_uint16));
	write_cmos_sensor(0x0138, 0x01);
}    /*    sensor_init  */
kal_uint16 addr_data_pair_preview_imx350main2[] = {
	0x0100, 0x00,
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx350main2_table_write_cmos_sensor(addr_data_pair_preview_imx350main2,
	sizeof(addr_data_pair_preview_imx350main2) / sizeof(kal_uint16));
}				/*    preview_setting  */
kal_uint16 addr_data_pair_capture_imx350main2[] = {
	0x0100, 0x00,
#ifdef IMX350MAIN2_24_FPS
	0x0112, 0x0A,
	0x0113, 0x0A,
...
kal_uint16 addr_data_pair_capture_imx350main2_pdaf_on[] = {
	0x3E37, 0x01,
	0x38A3, 0x01,
	0x38A4, 0x00,
	0x38A5, 0x70,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	imx350main2_table_write_cmos_sensor(addr_data_pair_capture_imx350main2,
	sizeof(addr_data_pair_capture_imx350main2) / sizeof(kal_uint16));
#if 0
	zvhdr_setting();
#endif
	if (imgsensor.pdaf_mode == 1) {
		imx350main2_table_write_cmos_sensor(
			addr_data_pair_capture_imx350main2_pdaf_on,
		sizeof(
		addr_data_pair_capture_imx350main2_pdaf_on) / sizeof(kal_uint16));
		imx350main2_apply_SPC();
	}
}
kal_uint16 addr_data_pair_video_imx350main2[] = {
	0x0100, 0x00,
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
static void normal_video_setting(kal_uint16 currefps)
{
	...
	imx350main2_table_write_cmos_sensor(addr_data_pair_video_imx350main2,
	sizeof(addr_data_pair_video_imx350main2) / sizeof(kal_uint16));
#if 0
	zvhdr_setting();
#endif
}
kal_uint16 addr_data_pair_hs_video_imx350main2[] = {
	0x0100, 0x00,
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	imx350main2_table_write_cmos_sensor(addr_data_pair_hs_video_imx350main2,
	sizeof(addr_data_pair_hs_video_imx350main2) / sizeof(kal_uint16));
	zvhdr_setting();
}
...
//prize add by lipengpeng 20200722 start
 #define ZXY_2_MODULE_ID_OFFSET  0x0001
static kal_uint16 read_module_id_zxy2(void)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(ZXY_2_MODULE_ID_OFFSET >> 8), (char)(ZXY_2_MODULE_ID_OFFSET & 0xFF)};

	iReadRegI2C(pusendcmd, 2, (u8 *)&get_byte, 1, 0xB0/*EEPROM_READ_ID*/);
	pr_err("the module id2 is 0x%x\n", get_byte);
	return get_byte;
}
...
static kal_uint32 imx350main2_awb_gain(struct SET_SENSOR_AWB_GAIN *pSetSensorAWB)
{
	UINT32 rgain_32, grgain_32, gbgain_32, bgain_32;
	LOG_INF("imx350main2_awb_gain\n");
	...
	LOG_INF("[imx350main2_awb_gain] ABS_GAIN_GR:%d, grgain_32:%d\n",
		pSetSensorAWB->ABS_GAIN_GR,	grgain_32);
	LOG_INF("[imx350main2_awb_gain] ABS_GAIN_R:%d, rgain_32:%d\n",
		pSetSensorAWB->ABS_GAIN_R, rgain_32);
	LOG_INF("[imx350main2_awb_gain] ABS_GAIN_B:%d, bgain_32:%d\n",
		pSetSensorAWB->ABS_GAIN_B, bgain_32);
	LOG_INF("[imx350main2_awb_gain] ABS_GAIN_GB:%d, gbgain_32:%d\n",
				  ...
				  UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_DATA:
		...
		imx350main2_read_DCC((kal_uint16) (*feature_data),
	...
	case SENSOR_FEATURE_SET_AWB_GAIN:
		imx350main2_awb_gain(pSetSensorAWB);
		break;
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx350main2_get_pdaf_reg_setting(
			(*feature_para_len) / sizeof(UINT32), feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_SET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		imx350main2_set_pdaf_reg_setting(
			(*feature_para_len) / sizeof(UINT32), feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDFOCUS_AREA:
		LOG_INF(
			"SENSOR_FEATURE_SET_imx350main2_PDFOCUS_AREA Start Pos=%d, Size=%d\n",
			(UINT32) *feature_data, (UINT32) *(feature_data + 1));
		imx350main2_set_pd_focus_area(*feature_data, *(feature_data + 1));
		break;
...
UINT32 IMX350MAIN2_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
