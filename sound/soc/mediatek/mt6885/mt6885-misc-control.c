				...
				struct snd_ctl_elem_value *ucontrol)
{
	...
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_DL_SRC2_CON0 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_ADDA_3RD_DAC_DL_SRC2_CON1, &value);
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_DL_SRC2_CON1 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_ADDA_3RD_DAC_PREDIS_CON0, &value);
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_PREDIS_CON0 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_ADDA_3RD_DAC_PREDIS_CON1, &value);
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_PREDIS_CON1 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_ADDA_3RD_DAC_PREDIS_CON2, &value);
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_PREDIS_CON2 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_ADDA_3RD_DAC_PREDIS_CON3, &value);
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_PREDIS_CON3 = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_DL_SDM_TEST = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_ADDA_3RD_DAC_DL_DC_COMP_CFG0, &value);
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_DL_DC_COMP_CFG0 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_ADDA_3RD_DAC_DL_DC_COMP_CFG1, &value);
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_DL_DC_COMP_CFG1 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_ADDA_3RD_DAC_DL_SDM_FIFO_MON, &value);
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_DL_SDM_FIFO_MON = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_ADDA_3RD_DAC_DL_SRC_LCH_MON, &value);
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_DL_SRC_LCH_MON = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_ADDA_3RD_DAC_DL_SRC_RCH_MON, &value);
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_DL_SRC_RCH_MON = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_ADDA_3RD_DAC_DL_SDM_OUT_MON, &value);
	dev_dbg(afe->dev, "AFE_ADDA_3RD_DAC_DL_SDM_OUT_MON = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_I2S_MON2 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_SINEGEN_CON_TDM, &value);
	dev_dbg(afe->dev, "AFE_SINEGEN_CON_TDM = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_HDMI_CONN0 = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_TINY_CONN2 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_TINY_CONN3, &value);
	dev_dbg(afe->dev, "AFE_TINY_CONN3 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_TINY_CONN4, &value);
	dev_dbg(afe->dev, "AFE_TINY_CONN4 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_TINY_CONN5, &value);
	dev_dbg(afe->dev, "AFE_TINY_CONN5 = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_IRQ_MCU_CNT31 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_TINY_CONN6, &value);
	dev_dbg(afe->dev, "AFE_TINY_CONN6 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_TINY_CONN7, &value);
	dev_dbg(afe->dev, "AFE_TINY_CONN7 = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_SGEN_CON_SGEN32 = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_TINY_CONN0 = 0x%x\n", value);
	regmap_read(afe->regmap, AFE_TINY_CONN1, &value);
	dev_dbg(afe->dev, "AFE_TINY_CONN1 = 0x%x\n", value);
	...
	dev_dbg(afe->dev, "AFE_MEMIF_CONN = 0x%x\n", value);
