...
static int mt6833_afe_pcm_platform_probe(struct snd_soc_component *platform)
{
...
const struct snd_soc_component_driver mt6833_afe_component = {
	.name     = AFE_PCM_NAME,
	.ops = &mtk_afe_pcm_ops,
...
static int mt6833_afe_pcm_dev_probe(struct platform_device *pdev)
{
	...
	dev_dbg(dev, "%s(), mt6833_init_clock\n", __func__);
	...
	dev_dbg(dev, "%s(), mt6833_afe_gpio_init\n", __func__);
