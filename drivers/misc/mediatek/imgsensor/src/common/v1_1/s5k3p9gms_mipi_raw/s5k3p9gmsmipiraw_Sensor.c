...
#include "s5k3p9gmsmipiraw_Sensor.h"


//extern int prize_gms_flag;
#define PFX "S5K3p9gms"
#define LOG_INF_NEW(format, args...)    pr_info(PFX "[%s] " format, __func__, ##args)
#define LOG_INF LOG_INF_NEW
#define LOG_1 LOG_INF("S5K3p9gms,MIPI 4LANE\n")
#define SENSORDB LOG_INF
/*prize add by zhuzhengjiang for compate with main & sub is 3p9gms 2019618 start*/
//extern int curr_sensor_id;
/*prize add by zhuzhengjiang for compate with main & sub is 3p9gms 2019618 end*/

static DEFINE_SPINLOCK(imgsensor_drv_lock);

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5K3P9GMS_SENSOR_ID,		/* record sensor id defined in Kd_imgsensor.h */
	...
	struct SET_SENSOR_PATTERN_SOLID_COLOR *pdata)
{
	...
	if (modes) {
		 write_cmos_sensor(0x0600, 0x01);
			write_cmos_sensor(0x0602, (0 >> 8) & 0x3);
			write_cmos_sensor(0x0603, 0 & 0xFF);
			write_cmos_sensor(0x0604, (0 >> 8) & 0x3);
			write_cmos_sensor(0x0605, 0 & 0xFF);
			write_cmos_sensor(0x0606, (0 >> 8) & 0x3);
			write_cmos_sensor(0x0607, 0 & 0xFF);
			write_cmos_sensor(0x0608, (0 >> 8) & 0x3);
			write_cmos_sensor(0x0609, 0 & 0xFF);
	} else
                             ...
                             UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	/******************** PDAF START >>> *********/
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:
			...
			/* S5K3p9gms_read_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2))); */
			break;
	/******************** PDAF END   <<< *********/
	default:
	    break;
