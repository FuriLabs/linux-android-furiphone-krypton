...
static void sensor_init(void)
{
	...
	#else
	write_cmos_sensor(0x00, read_cmos_sensor(0x00) | 0x00);  //prize add by zhuzhengjiang for mirror & flip [3]:mirror 0:normal 1:mirror  [2]:flip  0:normal  1:flip
	#endif
	LOG_INF( "<< sensor_init()\n" );
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	...
	kal_uint8 retry = 2;
	/*prize add by zhuzhengjiang for search camera 20200901 start*/
//	if(curr_sensor_id  == 4 || curr_sensor_id  == 3)
	{
