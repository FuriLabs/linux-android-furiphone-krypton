...
char *mtkfb_get_panel_name(void)
{
...
//prize-Gc7302 opening DSC requires 0x3e packet type sending-pengzhipeng-20220325-start
#define DSI_CUSTOM_HEADER    REG_FLD_MSB_LSB(31, 26)
#define CUSTOM_HEADER_EN        REG_FLD_MSB_LSB(23, 23)
//prize-Gc7302 opening DSC requires 0x3e packet type sending-pengzhipeng-20220325-end
...
static void mtk_dsi_ps_control_vact(struct mtk_dsi *dsi)
{
	...
	if (dsc_params->enable == 0) {
		...
		{
			SET_VAL_MASK(value, mask, 0x3e, DSI_CUSTOM_HEADER);
			SET_VAL_MASK(value, mask, 1, CUSTOM_HEADER_EN);
		}
		//prize-Gc7302 opening DSC requires 0x3e packet type sending-pengzhipeng-20220325-end
