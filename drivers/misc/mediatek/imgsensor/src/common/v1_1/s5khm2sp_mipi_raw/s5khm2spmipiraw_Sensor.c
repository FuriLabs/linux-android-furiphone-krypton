...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.i2c_speed = 1000,
	.i2c_addr_table = {0x7A, 0xff}, //record sensor support all write id addr, only supprt 4must end with 0xff
};
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{12000, 9000, 0,   0,    12000, 9000, 4000,  3000, 0, 0, 4000,  3000, 0, 0, 4000,  3000}, /* capture */ //{12000, 9000, 0,   0,    12000, 9000, 12000, 9000, 0, 0, 12000, 9000, 0, 0, 12000, 9000},
	{12000, 9000, 0,   0,    12000, 9000, 4000,  3000, 0, 0, 4000,  3000, 0, 0, 4000,  3000}, /* video */
	{12000, 9000, 0,   0,    12000, 9000, 3000,  2250, 540, 585, 1920,  1080, 0, 0, 1920,  1080},//{12000, 9000, 240, 1260, 11520, 6480, 1920,  1080, 0, 0, 1920,  1080, 0, 0, 1920,  1080}, /* high speed video */
	{12000, 9000, 0,   0,    12000, 9000, 2000,  1500, 0, 0, 2000,  1500, 0, 0, 2000,  1500}, /* slim video */
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info =
	{
		...
		.i4BlockNumY = 371,
		.iMirrorFlip = 0,    
		.i4PosL = {{19, 17}, {23, 18}, {21, 21}, {17, 22}},
		.i4PosR = {{18, 17}, {22, 18}, {20, 21}, {16, 22}},
...
static void sensor_init(void)
	{
	LOG_INF("+");
	write_cmos_sensor(0x6028, 0x4000);	 //// Page pointer HW 		
	write_cmos_sensor(0x0000, 0x0F22);	 //// Setfile Version 		
	write_cmos_sensor(0x0000, 0x1AD2);	 //// HM2( Sensor ID) 		
	write_cmos_sensor(0x001E, 0x759F);	 //// SVN 30111
...
#ifdef FPT_PDAF_SUPPORT
		   sensor_info->PDAF_Support = 2;	 //2-VC, 6-Raw
   #else 
			...
			case SENSOR_FEATURE_GET_SENSOR_PDAF_CAPACITY:
				...
				case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
					*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 1;
					break;
				case MSDK_SCENARIO_ID_VIDEO_PREVIEW:
					*(MUINT32 *)(uintptr_t)(*(feature_data + 1)) = 1; // video & preview use same setting
					break;
				case MSDK_SCENARIO_ID_HIGH_SPEED_VIDEO:
