...
#include "gc6133depthmipi_Sensor.h"
...
#define PFX "gc6133depth_camera_sensor"
#define LOG_1 LOG_INF("GC6133DEPTH, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/

#define LOG_INF(format, args...)    pr_err(PFX "[%s] " format, __func__, ##args)

static DEFINE_SPINLOCK(imgsensor_drv_lock);
kal_bool GC6133DEPTHDuringTestPattern = KAL_FALSE;

static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC6133DEPTH_MIPI_SENSOR_ID,
...
static kal_uint32 open(void)
{
	...
	spin_unlock(&imgsensor_drv_lock);
	GC6133DEPTHDuringTestPattern = KAL_FALSE;
	return ERROR_NONE;
}
...
UINT32 GC6133DEPTH_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
