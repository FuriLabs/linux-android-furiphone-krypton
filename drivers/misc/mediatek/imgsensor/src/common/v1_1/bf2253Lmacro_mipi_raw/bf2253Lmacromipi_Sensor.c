...
/****************************   Modify end    *******************************************/
#define BF2253LMACRO_MIRROR_FLIP_ENABLE 1
...
static kal_uint16 sensorGainMapping[MaxGainIndex][2] ={
 ...
 {8000  ,65},
 {8216  ,66},
 #if 0  // 8 gain,if want 10 gain ,please open
 {8439  ,67},
 {8648  ,68},
 {8859  ,69},
 {9065  ,70},
...
static void sensor_init(void)
{
	...
	write_cmos_sensor(0xe2,0x0e);//0x06zj
	write_cmos_sensor(0xe3, 0x0e);
	write_cmos_sensor(0xe4, 0x40);
	write_cmos_sensor(0xe5,0x33);//0x67zj
	write_cmos_sensor(0xe6,0x00);//0x02zj
	...
	write_cmos_sensor(0xd0,0x08);
  //prize add by zhuzhengjiang for mirror & flip [3]:mirror 0:normal 1:mirror  [2]:flip  0:normal  1:flip
#if BF2253LMACRO_MIRROR_FLIP_ENABLE
	write_cmos_sensor(0x00, read_cmos_sensor(0x00) | 0x0c);
#elif BF2253LMACRO_MIRROR_ENABLE	
	write_cmos_sensor(0x00, read_cmos_sensor(0x00) | 0x08);
#elif BF2253LMACRO_FLIP_ENABLE
	write_cmos_sensor(0x00, read_cmos_sensor(0x00) | 0x04);
#endif
	LOG_INF( "<< sensor_init()\n" );
}
...
static kal_uint32 bf2253Lmacro_ana_gain_table[] = {
     1024,	1088,	 1150,	1214, 
     1277,	1342,	 1403,	1468, 
     1527,	1594,	 1652,	1716, 
     1775,	1839,	 1897,	1960, 
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
	 if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL
	                            || *(feature_data + 0) == 0) {
	        *(feature_data + 0) =
	            sizeof(bf2253Lmacro_ana_gain_table)/sizeof(kal_uint32);
    } else {
        memcpy((void *)(uintptr_t) (*(feature_data + 1)),
        (void *)bf2253Lmacro_ana_gain_table,
        sizeof(bf2253Lmacro_ana_gain_table)/sizeof(kal_uint32));
    }	
		break;		
