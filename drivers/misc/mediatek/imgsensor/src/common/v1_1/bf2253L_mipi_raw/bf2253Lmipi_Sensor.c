...
/****************************   Modify end    *******************************************/
#define BF2253_MIRROR_FLIP_ENABLE 1
#define BF2253_MIRROR_ENABLE 0
#define BF2253_FLIP_ENABLE 0
	...
	UINT8 *feature_para, UINT32 *feature_para_len)
{
    ...
    case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
	 if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL
	                            || *(feature_data + 0) == 0) {
	        *(feature_data + 0) =
	            sizeof(bf2253L_ana_gain_table)/sizeof(kal_uint32);
    } else {
        memcpy((void *)(uintptr_t) (*(feature_data + 1)),
        (void *)bf2253L_ana_gain_table,
        sizeof(bf2253L_ana_gain_table)/sizeof(kal_uint32));
    }	
		break;		
