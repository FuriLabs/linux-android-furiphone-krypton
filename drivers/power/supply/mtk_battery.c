...
// prize modify by liaoxingen for vts/cts test, start 20221116
#if defined(CONFIG_MTK_CW2217_SUPPORT)
	if(bat_psy != NULL && !IS_ERR(bat_psy)) {
		ret = power_supply_get_property(bat_psy,POWER_SUPPLY_PROP_CAPACITY,val);
		gm->ui_soc = val->intval;
	}
#endif
// prize modify by liaoxingen for vts/cts test, end 20221116
...
#if defined(CONFIG_MTK_CW2015_BATTERY_ID_AUXADC)||defined(CONFIG_MTK_CW2217_BATTERY_ID_AUXADC)
