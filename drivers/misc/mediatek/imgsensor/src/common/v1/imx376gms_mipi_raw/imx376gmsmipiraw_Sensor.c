...
#include "imx376gmsmipiraw_Sensor.h"
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.i2c_addr_table = {0x34, 0x35, 0x20, 0x21, 0xff},
...
{ 5184, 3880, 0, 0, 5184, 3880, 2592, 1940, 0000, 0000, 2592, 1940,0, 0, 2592, 1940}, /* capture*/
...
{ 5184, 3880, 0, 0, 5184, 3880, 2592, 1940, 0000, 0000, 2592, 1940,0, 0, 2592, 1940}, /*custom1*/
{ 5184, 3880, 0, 0, 5184, 3880, 2592, 1940, 0000, 0000, 2592, 1940,0, 0, 2592, 1940}, /*custom2*/
{ 5184, 3880, 0, 0, 5184, 3880, 5184, 3880, 0000, 0000, 5184, 3880,0, 0, 5184, 3880}, /*custom3*/
};
#else
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[8] = {
{ 2592, 1940, 0, 0, 2592, 1940, 2592, 1940, 0000, 0000, 2592, 1940,0, 0, 2592, 1940},/*Preview*/
{ 2592, 1940, 0, 0, 2592, 1940, 2592, 1940, 0000, 0000, 2592, 1940,0, 0, 2592, 1940}, /* capture*/
{ 2592, 1940, 0, 0, 2592, 1940, 2592, 1940, 0000, 0000, 2592, 1940,0, 0, 2592, 1940}, /* video */
{ 2592, 1940, 0, 0, 2592, 1940, 2592, 1940, 0000, 0000, 2592, 1940,0, 0, 2592, 1940}, /*hs video*/
{ 2592, 1940, 0, 0, 2592, 1940, 2592, 1940, 0000, 0000, 2592, 1940,0, 0, 2592, 1940}, /*slim video*/
};
#endif
#if 0
...
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(LENS_ID_OFFSET >> 8),
				(char)(LENS_ID_OFFSET & 0xFF) };
...
static kal_uint16 gain2reg(const kal_uint16 gain)
{
	...
	LOG_INF("imx376gms gain =%d, reg_gain =%d\n", gain, reg_gain);
...
#endif
static kal_uint16 imx376gms_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_imx376gms[] = {
	0x0136, 0x18,
	0x0137, 0x00,
	0x3C7D, 0x28,
	0x3C7E, 0x02,
...
{
	imx376gms_table_write_cmos_sensor(addr_data_pair_init_imx376gms,
		sizeof(addr_data_pair_init_imx376gms)/sizeof(kal_uint16));
}	/*	sensor_init  */

kal_uint16 addr_data_pair_preview_imx376gms[] = {
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
	0x0342, 0x1B,
...
static void preview_setting(void)
{
	...
	imx376gms_table_write_cmos_sensor(addr_data_pair_preview_imx376gms,
		sizeof(addr_data_pair_preview_imx376gms) / sizeof(kal_uint16));
}	/*	preview_setting  */
/* ==================================================== */
/* 3P3SP EVT0 */
/* Full resolution */
...
kal_uint16 addr_data_pair_capture_imx376gms[] = {
#if USE_REMOSAIC
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
static void capture_setting(kal_uint16 currefps, kal_bool stream_on)
{
	...
	imx376gms_table_write_cmos_sensor(addr_data_pair_capture_imx376gms,
		sizeof(addr_data_pair_capture_imx376gms) / sizeof(kal_uint16));
}
...
kal_uint16 addr_data_pair_custom3_imx376gms[] = {
#if USE_REMOSAIC
	0x0112, 0x0A,
	0x0113, 0x0A,
	0x0114, 0x03,
...
{
	LOG_INF("E\n");
	imx376gms_table_write_cmos_sensor(addr_data_pair_custom3_imx376gms,
		sizeof(addr_data_pair_custom3_imx376gms) / sizeof(kal_uint16));
}
#endif
/*************************************************************************
 * FUNCTION
		...
		do {
			*sensor_id =( ((read_cmos_sensor_8(0x0016) << 8) |
			...
			/*zhaozhengtao 2016/02/19,modify for different module*/
				...
				if(lens_id == 0x11)
				{
					pr_debug("gms lens_id success(0x%x) module_id(0x%x)",lens_id,imgsensor_info.module_id);
					return ERROR_NONE;
				}
				else
				{
					pr_debug("gms lens_id fail(0x%x) module_id(0x%x)",lens_id,imgsensor_info.module_id);
...
static kal_uint32 open(void)
{
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			...
			if ((sensor_id == imgsensor_info.sensor_id)&&(lens_id == 0x11)) {
...
{
	int i = 0;
	int addr = 0x0F53;/*Start of 4 cell data*/
...
/* kin0603 */
UINT32 IMX376GMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
