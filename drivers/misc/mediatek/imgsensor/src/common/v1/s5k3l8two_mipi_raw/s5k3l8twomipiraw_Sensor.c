...
#include "s5k3l8twomipiraw_Sensor.h"
...
#endif
static kal_uint16 s5k3l8two_table_write_cmos_sensor(
...
kal_uint16 addr_data_pair_init_s5k3l8two[] = {
	0x6028, 0x4000,
	0x6214, 0xFFFF,
	0x6216, 0xFFFF,
	0x6218, 0x0000,
...
{
	pr_info("E\n");
	s5k3l8two_table_write_cmos_sensor(addr_data_pair_init_s5k3l8two,
	    sizeof(addr_data_pair_init_s5k3l8two)/sizeof(kal_uint16));
}	/*	sensor_init  */

kal_uint16 addr_data_pair_preview_s5k3l8two[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
{
	pr_info("E\n");
	s5k3l8two_table_write_cmos_sensor(
	addr_data_pair_preview_s5k3l8two,
	sizeof(addr_data_pair_preview_s5k3l8two) / sizeof(kal_uint16));
}	/*	preview_setting  */


kal_uint16 addr_data_pair_capture_s5k3l8two_30fps[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
kal_uint16 addr_data_pair_capture_s5k3l8two_24fps[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
kal_uint16 addr_data_pair_capture_s5k3l8two_15fps[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
kal_uint16 addr_data_pair_capture_s5k3l8two_fps[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
static void capture_setting(kal_uint16 currefps)
{
	...
	if (currefps == 300) {
		s5k3l8two_table_write_cmos_sensor(
			addr_data_pair_capture_s5k3l8two_30fps,
	sizeof(addr_data_pair_capture_s5k3l8two_30fps) / sizeof(kal_uint16));
	} else if (currefps == 240) {
		s5k3l8two_table_write_cmos_sensor(
			addr_data_pair_capture_s5k3l8two_24fps,
	sizeof(addr_data_pair_capture_s5k3l8two_24fps) / sizeof(kal_uint16));
	} else if (currefps == 150) {
		s5k3l8two_table_write_cmos_sensor(
			addr_data_pair_capture_s5k3l8two_15fps,
	sizeof(addr_data_pair_capture_s5k3l8two_15fps) / sizeof(kal_uint16));
	} else {
		s5k3l8two_table_write_cmos_sensor(
			addr_data_pair_capture_s5k3l8two_fps,
	sizeof(addr_data_pair_capture_s5k3l8two_fps) / sizeof(kal_uint16));
	}
}
...
kal_uint16 addr_data_pair_hs_video_s5k3l8two[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
{
	pr_info("E\n");
	s5k3l8two_table_write_cmos_sensor(addr_data_pair_hs_video_s5k3l8two,
		sizeof(addr_data_pair_hs_video_s5k3l8two) / sizeof(kal_uint16));
}

kal_uint16 addr_data_pair_slim_video_s5k3l8two[] = {
	0x6028, 0x2000,
	0x602A, 0x0F74,
	0x6F12, 0x0040,
	0x6F12, 0x0040,
...
{
	pr_info("E\n");
	s5k3l8two_table_write_cmos_sensor(addr_data_pair_slim_video_s5k3l8two,
		sizeof(addr_data_pair_slim_video_s5k3l8two) / sizeof(kal_uint16));
}
...
UINT32 S5K3L8TWO_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc != NULL)
		*pfFunc =  &sensor_func;
	return ERROR_NONE;
}	/*	S5K3L8TWO_MIPI_RAW_SensorInit	*/
