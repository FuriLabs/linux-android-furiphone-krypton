...
//prize-Turn on the esd detect splash screen function, so that the 0A register has a change-pengzhipeng-20220916-start
lcm_dcs_write_seq_static(ctx,0xC7,0x05);
lcm_dcs_write_seq_static(ctx,0x48,0x09);
lcm_dcs_write_seq_static(ctx,0x26,0x42);
//prize-Turn on the esd detect splash screen function, so that the 0A register has a change-pengzhipeng-20220916-end
