 ...
 *============================================================================
 *
 * Version:  V20221102123351 by GC-S-TEAM
 *
...
static struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
  ...
  { 4208, 3120, 0, 0, 4208, 3120, 2104, 1560, 0, 0, 2104, 1560, 0, 0, 2104, 1560}, /* Preview */
	...
	{ 4208, 3120, 0, 0, 4208, 3120, 1052, 780, 206, 150, 640, 480, 0, 0, 640, 480}, /* hs video */
	{ 4208, 3120, 0, 0, 4208, 3120, 2104, 1560, 412, 420, 1280, 720, 0, 0, 1280, 720}  /* slim video */
};
...
static struct SET_PD_BLOCK_INFO_T imgsensor_pd_info = {
	...
	.i4PosR = {
		...
		{32, 43},{48, 47},{60, 47},{76, 43},
		{32, 67},{48, 63},{60, 63},{76, 67},
		{28, 79},{44, 75},{64, 75},{80, 79}
    },
    .i4PosL = {
		{28, 27},{44, 31},{64, 31},{80, 27},
		{32, 47},{48, 51},{60, 51},{76, 47},
		{32, 63},{48, 59},{60, 59},{76, 63},
	...
	.i4PosR = {
		{31, 28},{47, 32},{67, 32},{83, 28},
		{35, 48},{51, 52},{63, 52},{79, 48},
		{35, 64},{51, 60},{63, 60},{79, 64},
		{31, 84},{47, 80},{67, 80},{83, 84}
    },
    .i4PosL = {
		{31, 32},{47, 36},{67, 36},{83, 32},
		{35, 44},{51, 48},{63, 48},{79, 44},
		{35, 68},{51, 64},{63, 64},{79, 68},
		{31, 80},{47, 76},{67, 76},{83, 80} 
...
static kal_uint16 gc13a0_hs_video_addr_data[] = {
	0x031c,0x20,
	0x0337,0x05,
	0x0335,0x05,
	0x0253,0x02,
...
{
	gc13a0_stream_off();
	table_write_cmos_sensor(gc13a0_hs_video_addr_data,
		sizeof(gc13a0_hs_video_addr_data)/sizeof(kal_uint16));
	gc13a0_stream_on();
}
	...
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		do {
			*sensor_id = return_sensor_id();
			...
			pr_err("[gc13a0_camera_sensor]get_imgsensor_id:Read sensor id fail, write id: 0x%x, id: 0x%x\n",
				imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
