 ...
 * Filename:
 * ---------
 *   OV16A10GMS_REAR_rear_mipiraw_Sensor.c
 *
 * Project:
 * --------
 *	 ALPS
...
#include "ov16a10gmsmipiraw_Sensor.h"
//#include "ov16a1q_eeprom.h"

#define PFX "OV16A10GMS_camera_sensor"
...
static  struct SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[7] ={
	...
	{4656, 3496,    400,  660, 3856, 2176, 1928, 1088,  4, 4,  1920, 1080,     0,    0, 1920, 1080}, //hight speed video
...
// prize add for start-up slow by zhuzhengjiang 20200603 start
#if USE_BURST_MODE
static kal_uint16 ov16A10gms_table_write_cmos_sensor(kal_uint16 *para,
						 kal_uint32 len)
{
...
#if USE_BURST_MODE
static kal_uint16 ov16A10gms_init_setting[] = {
...
static kal_uint16 ov16A10gms_preview_setting[] = {	/*	preview_setting  */
...
static kal_uint16 ov16A10gms_normal_capture_setting[] = {
...
static kal_uint16 ov16A10gms_pip_capture_setting[] = {
...
static kal_uint16 ov16A10gms_pip_capture_15fps_setting[] = {
...
static kal_uint16 ov16A10gms_hs_video_setting[] = {
...
static void sensor_init(void)
{
	...
	ov16A10gms_table_write_cmos_sensor(ov16A10gms_init_setting,
		sizeof(ov16A10gms_init_setting)/sizeof(kal_uint16));
#else	
...
// prize add for start-up slow by zhuzhengjiang 20200603 start	
	...
	//mdelay(20);
#if USE_BURST_MODE  
	ov16A10gms_table_write_cmos_sensor(ov16A10gms_preview_setting,
		sizeof(ov16A10gms_preview_setting)/sizeof(kal_uint16));
#else	
...
// prize add for start-up slow by zhuzhengjiang 20200603 start
	...
	ov16A10gms_table_write_cmos_sensor(ov16A10gms_normal_capture_setting,
		sizeof(ov16A10gms_normal_capture_setting)/sizeof(kal_uint16));
#else	
...
// prize add for start-up slow by zhuzhengjiang 20200603 start
	...
	//mdelay(20);
#if USE_BURST_MODE 
	ov16A10gms_table_write_cmos_sensor(ov16A10gms_pip_capture_setting,
		sizeof(ov16A10gms_pip_capture_setting)/sizeof(kal_uint16));
#else
	write_cmos_sensor_8(0x0305, 0x89);
	write_cmos_sensor_8(0x0307, 0x00);
	write_cmos_sensor_8(0x4837, 0x0a);
...
// prize add for start-up slow by zhuzhengjiang 20200603 start
	...
	//mdelay(20);
#if USE_BURST_MODE 
	ov16A10gms_table_write_cmos_sensor(ov16A10gms_pip_capture_15fps_setting,
		sizeof(ov16A10gms_pip_capture_15fps_setting)/sizeof(kal_uint16));
#else
	write_cmos_sensor_8(0x0305, 0x89);
	write_cmos_sensor_8(0x0307, 0x00);
	write_cmos_sensor_8(0x4837, 0x0a);
...
// prize add for start-up slow by zhuzhengjiang 20200603 start	
	...
	//mdelay(20);
#if USE_BURST_MODE 
	ov16A10gms_table_write_cmos_sensor(ov16A10gms_hs_video_setting,
		sizeof(ov16A10gms_hs_video_setting)/sizeof(kal_uint16));
#else
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
        kal_uint16 gms_otp_value = 0;
        kal_uint16 gms_otp_value2 = 0;
        kal_uint16 gms_otp_value3 = 0;
	...
	if(curr_sensor_id != 0)
	{
		*sensor_id = 0xFFFFFFFF;
        ...
        pr_debug("[ov16A10gms_camera_sensor ] imgsensor_info.sensor_id:%x\n",imgsensor_info.sensor_id);
	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		spin_lock(&imgsensor_drv_lock);
		imgsensor.i2c_write_id = imgsensor_info.i2c_addr_table[i];
                pr_debug("[ov16A10gms_camera_sensor ] imgsensor_info.i2c_addr_table[i]:%x\n",imgsensor_info.i2c_addr_table[i]);
		spin_unlock(&imgsensor_drv_lock);
		do {	
			*sensor_id = (read_cmos_sensor_8(0x300A) << 16) | (read_cmos_sensor_8(0x300B)<<8) | read_cmos_sensor_8(0x300C);
                        ...
                        pr_debug("[ov16A10gms_camera_sensor ] otp val:0x%x,0x%x,0x%x",gms_otp_value,gms_otp_value2,gms_otp_value3);
                        if(gms_otp_value == 0x55 && gms_otp_value2 == 0x55 && gms_otp_value3 == 0x55 )
                        {
                                *sensor_id = *sensor_id+1;
                        }

                        pr_debug("[ov16A10gms_camera_sensor ] get_imgsensor_id :%x\n",*sensor_id);
...
UINT32 OV16A10GMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	/* To Do : Check Sensor status here */
	if (pfFunc!=NULL)
		*pfFunc=&sensor_func;
	return ERROR_NONE;
}	/*	OV16A10GMS_MIPI_RAW_SensorInit	*/
