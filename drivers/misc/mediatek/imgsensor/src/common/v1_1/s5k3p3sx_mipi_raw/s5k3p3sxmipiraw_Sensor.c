...
//prize add by lipengpeng 20200215 start
 #define ZXY_3P3SX_MODULE_ID_OFFSET  0x0004
static kal_uint16 read_zxy3p3sxmodule_id(void)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(ZXY_3P3SX_MODULE_ID_OFFSET >> 8), (char)(ZXY_3P3SX_MODULE_ID_OFFSET & 0xFF)};
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	kal_uint16 zxy3p3sxmodule_id = 0;
